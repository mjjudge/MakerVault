...
- [x] Inventory hygiene dashboard: missing documents, aliases, capabilities (Epic 15)
- [x] "Parts stored in multiple locations" split-stock insight (Epic 15)
- [x] "Possible duplicates" review queue in the UI (Epic 15)
- [x] Part merge workflow: safely consolidate duplicate Part records (Epic 15)
